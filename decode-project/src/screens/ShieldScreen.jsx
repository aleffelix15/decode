    ...
    <div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Panel className="p-6 flex flex-col items-center text-center">
          <ShieldCheck size={56} style={{ color: tier > 0 ? C.lilac : C.sub }} aria-hidden="true" />
          <p className="font-bold mt-3" style={{ color: C.text }}>{story.chapter}/5 capítulos concluídos</p>
        ...
        <Panel className="p-6">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3">
              <Phone size={16} style={{ color: C.lilac }} aria-hidden="true" />
              <div>
                <p className="text-sm font-semibold" style={{ color: C.text }}>Ligue 180</p>
                <p className="text-[11px]" style={{ color: C.sub }}>Central de Atendimento à Mulher</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px]" style={{ color: C.sub }}>Emergência policial</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Shield size={16} style={{ color: C.lilac }} aria-hidden="true" />
              <div>
                <p className="text-sm font-semibold" style={{ color: C.text }}>DEAM</p>
                <p className="text-[11px]" style={{ color: C.sub }}>Delegacia Especializada de Atendimento à Mulher mais próxima de você</p>
              </div>
            </div>
          </div>
