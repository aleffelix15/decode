  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-3 xs:px-4 sm:px-6 py-10 xs:py-12 sm:py-14 md:py-20 text-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-lg xs:max-w-xl w-full px-1 xs:px-2 sm:px-3">
        ...
        <div className="flex items-center justify-center gap-2 mt-4 xs:mt-5 sm:mt-7 text-2xs xs:text-xs font-semibold" style={{ color: rgba(C.lilac, 0.9) }}>
          <div className="w-3 xs:w-4 h-3 xs:h-4 rounded-full border shrink-0" style={{ borderColor: C.lilac }} />
          AGOSTO LILÁS
        </div>
